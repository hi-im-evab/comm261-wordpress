...
class CMB2_Render_Store_list_Field extends CMB2_Type_Base {
	...
	public function render() {
		...
		<div style="float:left;"><p><label for="<?php echo $this->_id( '_store_icon' ); ?>"><?php echo esc_html( $this->_text( 'store_icon_text', 'Store Icon' ) ); ?></label></p>
		...
		<div style="clear:both;float:left;"><p><label for="<?php echo $this->_id( '_store_name' ); ?>"><?php echo esc_html( $this->_text( 'store_name_text', 'Store Name' ) ); ?></label></p>
		...
		<div style="float:left;"><p><label for="<?php echo $this->_id( '_store_link'); ?>"><?php echo esc_html( $this->_text( 'store_link_text', 'Store Link' ) ); ?></label></p>
			<?php echo $this->types->input( array(

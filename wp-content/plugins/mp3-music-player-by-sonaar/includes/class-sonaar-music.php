...
class Sonaar_Music {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_admin, 'add_shortcode' );
		...
		$this->loader->add_action( 'wp_ajax_playlist', $plugin_admin, 'print_playlist_json' );
		$this->loader->add_action( 'wp_ajax_nopriv_playlist', $plugin_admin, 'print_playlist_json' );
		...
		$this->loader->add_action('admin_footer', $plugin_admin, 'adminfooter');
	}
